...
import DataTableDialog from '@/components/data-table/DataTableDialog.vue'
import ItemInspect from '@/components/data-table/ItemInspect.vue'
import ItemCreate from '@/components/data-table/ItemCreate.vue'
import ItemUpdate from '@/components/data-table/ItemUpdate.vue'
import ItemReport from '@/components/data-table/ItemReport.vue'
